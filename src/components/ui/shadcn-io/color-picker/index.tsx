...
export const ColorPicker = ({
  ...
  // Inicializar con el valor o defaultValue
...
export const ColorPickerSelection = memo(
  ({ className, ...props }: ColorPickerSelectionProps) => {
    ...
    // Calcular posición inicial basada en saturation y lightness
    const [positionX, setPositionX] = useState(saturation / 100);
    const [positionY, setPositionY] = useState(1 - (lightness / 100));

    // Actualizar posición cuando cambian saturation/lightness externamente
    useEffect(() => {
